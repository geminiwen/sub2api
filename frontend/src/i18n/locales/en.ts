export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      noProxy: 'No Proxy',
      concurrency: 'Concurrency',
      sessionLimitEnabled: 'Enable session limit',
      sessionLimitHint: 'Limit the maximum number of sessions per account within a time window (controlled by global config)',
      priority: 'Priority',
